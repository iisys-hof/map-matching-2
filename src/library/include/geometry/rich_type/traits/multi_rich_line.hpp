...
#ifndef MAP_MATCHING_2_TRAITS_MULTI_RICH_LINE_HPP
#define MAP_MATCHING_2_TRAITS_MULTI_RICH_LINE_HPP
...
namespace map_matching_2::geometry {
    ...
    struct multi_rich_line_traits {
        ...
        using rich_line_type = typename multi_rich_line_type::rich_line_type;
        using rich_lines_container_type = typename multi_rich_line_type::rich_lines_container_type;
        using line_type = typename rich_line_type::line_type;
        using multi_line_type = typename multi_rich_line_type::multi_line_type;
...
#endif //MAP_MATCHING_2_TRAITS_MULTI_RICH_LINE_HPP
