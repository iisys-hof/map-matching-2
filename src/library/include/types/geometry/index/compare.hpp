...
#define MM2_COMPARE_RTREE_TIME_POINTS(CS) MM2_RTREE((MM2_TIME_POINT(CS)), MM2_MEMORY_TYPES)
...
#define MM2_COMPARE_RTREE_POINTS_TEMPLATE(CS) \
    ...
    MM2_EXTERN template class MM2_COMPARE_RTREE_TIME_POINTS(CS);
...
#define MM2_COMPARE_RTREE_SEGMENTS_TEMPLATE_CS(CS) \
    ...
    MM2_COMPARE_RTREE_SEGMENTS_TEMPLATE((MM2_RICH_TIME_SEGMENT(CS, MM2_SEGMENT))) \
    MM2_COMPARE_RTREE_SEGMENTS_TEMPLATE((MM2_EAGER_RICH_TIME_SEGMENT(CS, MM2_SEGMENT))) \
    MM2_COMPARE_RTREE_SEGMENTS_TEMPLATE((MM2_LAZY_RICH_TIME_SEGMENT(CS, MM2_SEGMENT)))
