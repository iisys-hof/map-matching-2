...
#ifndef MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_MULTI_RICH_LINE_HPP
#define MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_MULTI_RICH_LINE_HPP
...
#define MM2_MULTI_RICH_LINE_TEMPLATE_CS(CS) \
    MM2_MULTI_RICH_LINE_TEMPLATE(CS, MM2_MEMORY_TYPES) \
    MM2_MULTI_RICH_LINE_TEMPLATE(CS, MM2_MMAP_TYPES)

MM2_MULTI_RICH_LINE_TEMPLATE_CS(MM2_GEOGRAPHIC)
MM2_MULTI_RICH_LINE_TEMPLATE_CS(MM2_SPHERICAL_EQUATORIAL)
MM2_MULTI_RICH_LINE_TEMPLATE_CS(MM2_CARTESIAN)
...
namespace map_matching_2::geometry {
    ...
    using multi_rich_line_type = multi_rich_line<rich_line_type<Point, Types>,
        Types::template vector_type, Types::template allocator_type>;

    template<is_point Point, io::memory_mapped::is_types Types = io::memory_mapped::memory_types>
    using import_multi_rich_line_type = multi_rich_line<import_rich_line_type<Point, Types>,
        Types::template vector_type, Types::template fast_counting_allocator_type>;

}

#endif //MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_MULTI_RICH_LINE_HPP
