...
#ifndef MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_LAZY_RICH_SEGMENT_HPP
#define MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_LAZY_RICH_SEGMENT_HPP
...
#include "geometry/rich_type/lazy_rich_segment.hpp"
...
#define MM2_LAZY_RICH_SEGMENT_TEMPLATE_CS(CS) \
    ...
    MM2_LAZY_RICH_SEGMENT_TEMPLATE(CS, MM2_POINTING_SEGMENT) \
    MM2_LAZY_RICH_SEGMENT_TEMPLATE(CS, MM2_REFERRING_SEGMENT)

MM2_LAZY_RICH_SEGMENT_TEMPLATE_CS(MM2_GEOGRAPHIC)
MM2_LAZY_RICH_SEGMENT_TEMPLATE_CS(MM2_SPHERICAL_EQUATORIAL)
MM2_LAZY_RICH_SEGMENT_TEMPLATE_CS(MM2_CARTESIAN)
...
#endif //MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_LAZY_RICH_SEGMENT_HPP
