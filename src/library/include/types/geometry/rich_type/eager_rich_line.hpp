...
#ifndef MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_EAGER_RICH_LINE_HPP
#define MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_EAGER_RICH_LINE_HPP
...
#include "geometry/rich_type/eager_rich_line.hpp"
...
#define MM2_EAGER_RICH_LINE_TEMPLATE_CS(CS) \
    MM2_EAGER_RICH_LINE_TEMPLATE(CS, MM2_MEMORY_TYPES) \
    MM2_EAGER_RICH_LINE_TEMPLATE(CS, MM2_MMAP_TYPES)

MM2_EAGER_RICH_LINE_TEMPLATE_CS(MM2_GEOGRAPHIC)
MM2_EAGER_RICH_LINE_TEMPLATE_CS(MM2_SPHERICAL_EQUATORIAL)
MM2_EAGER_RICH_LINE_TEMPLATE_CS(MM2_CARTESIAN)
...
namespace map_matching_2::geometry {
    ...
    using eager_rich_line_type = eager_rich_line<Point, Types::template vector_type, Types::template allocator_type>;

    template<is_point Point, io::memory_mapped::is_types Types = io::memory_mapped::memory_types>
    using import_eager_rich_line_type = eager_rich_line<Point, Types::template vector_type,
        Types::template fast_counting_allocator_type>;

}

#endif //MAP_MATCHING_2_TYPES_GEOMETRY_RICH_TYPE_EAGER_RICH_LINE_HPP
