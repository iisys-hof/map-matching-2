...
#define MM2_LAZY_MULTI_RICH_TIME_LINE(CS, TYPES) map_matching_2::geometry::lazy_multi_rich_line< \
    MM2_LAZY_RICH_TIME_LINE(CS, TYPES), MM2_VECTOR(TYPES), MM2_ALLOCATOR(TYPES)>
...
#define MM2_LAZY_MULTI_RICH_LINE_TEMPLATE(CS, TYPES) \
    ...
    MM2_EXTERN template class MM2_LAZY_MULTI_RICH_TIME_LINE(CS, TYPES); \
