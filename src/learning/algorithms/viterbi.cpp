...
namespace map_matching_2::learning {
    ...
    viterbi<Environment>::viterbi(Environment &environment, const learning::settings &settings)
            : _environment{environment}, _settings{settings} {}

    template<typename Environment>
    std::vector<std::pair<std::size_t, std::size_t>> viterbi<Environment>::operator()() {
    ...
    template
    class viterbi<environment::hmm<matching::types_geographic::matcher_static>>;

    template
    class viterbi<environment::hmm<matching::types_cartesian::matcher_static>>;
