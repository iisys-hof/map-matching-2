...
#include "q_learning_performance.hpp"
...
namespace map_matching_2::learning {
    ...
    q_learning_performance<Environment>::q_learning_performance(
    ...
    template<typename Environment>
    std::vector<std::pair<std::size_t, std::size_t>> q_learning_performance<Environment>::operator()() {
...
//        csv << std::vector{"score", "best"};
    ...
    template
    class q_learning_performance<environment::single_performance<matching::types_geographic::matcher_static>>;

    template
    class q_learning_performance<environment::single_performance<matching::types_cartesian::matcher_static>>;
